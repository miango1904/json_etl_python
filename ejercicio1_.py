...
def serializar():
    ...
    usuario = {"nombre": "mick",
               ...
               "vestuario": [
                    ...
                    {
                     "prenda 1": "remeras",'cantidad':14
                    }
                    ]
                    }
    prueba_string = json.dumps(usuario, indent=4)
    print(prueba_string)
...
def deserializar():
    ...
    json_verifica = {"max": usuario,}
    with open('mi_json.json', 'r') as jsonfile:
        current_data = json.load(jsonfile)
        current_data.append(usuario)
    json_string = json.dumps(usuario, indent=4)
    print(usuario) 
